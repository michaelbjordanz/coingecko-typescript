...
import type { OutlierpharoahcexcultEth } from '../client';
...
export const maybeMultipartFormRequestOptions = async (
  opts: RequestOptions,
  fetch: OutlierpharoahcexcultEth | Fetch,
 ...
 */
function supportsFormData(fetchObject: OutlierpharoahcexcultEth | Fetch): Promise<boolean> {
